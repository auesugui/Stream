  ...
  return (
    <div className="subBox" >
      <div className="subButtonContainer">
        <button className='editSubButton' id='editSubButton' onClick={setTogglePopup}>mode_edit</button>
        <button className='deleteSubButton' id='deleteSubButton' onClick={handleDelete}>delete</button>
      </div>
      <h4>{`Name: ${name}`}</h4>
      ...
      <main>
        <Popup trigger={togglePopup} setTrigger={setTogglePopup}>
          <h3>
            <div>
              <div>
        Edit Subscription Information<br/><br/>
                <input type='text' id='name' value={updatedSubInfo.name} onChange={updateInput} />
              </div>
              <div style={{marginTop: 10}}>
                <span><input className='sub-cost' id='cost' type='number' value={updatedSubInfo.cost}  onChange={updateInput} /> /month</span>
              </div>
              <div style={{marginTop: 10}}>
